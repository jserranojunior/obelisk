...
describe("calculateMonthOfLife()", () => {
  ...
  test("For month (return aways = '4')", () => {  
    ...
    const DATE_FOR_MONTH = new Date(dateForTest.getFullYear(), dateForTest.getMonth() + 4, dateForTest.getDay()).toLocaleDateString("fr-ca");
    console.log(DATE_FOR_MONTH, dateForTest, "Date teste")
